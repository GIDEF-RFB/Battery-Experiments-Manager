...
urlpatterns = [
    ...
    path('validate-profile/', views.validate_profile, name='validate-profile'),
    path('validate-field/', views.validate_field, name='validate-field'),
    path('apply-experiments-filters/', views.apply_experiments_filters,
        name='apply-experiments-filters'),
    path('csv<int:exp_id_selected>/', views.getCsv, name='csv'),
    path('report<int:exp_id_selected>/', views.getReport, name='report'),
    path('report_template<int:exp_id_selected>/', views.loadReportTemplate,
         name='report_template'),
    path('preview<int:exp_id_selected>/', views.loadReportTemplate,
        name='report_template'),
    path('get-new-measures/', views.getNewMeasures, name='get-new-measures'),
    path('translate-measures-names/', views.translateMeasuresNames,
        name='translate-measures-names'),
